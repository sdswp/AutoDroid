...
public class StressTest extends BaseStability {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setBaseContentView(R.layout.stresstest);
	...
	private void initView() {
		...
		tips.setText(R.string.plan_StressTest_desc);
		...
		if (planIdExist(sp, pidKey)) {
			String json = us.getRawFile(R.raw.stresstest);
	...
	private class paramsSetting implements OnClickListener {
		@Override
		public void onClick(View v) {
