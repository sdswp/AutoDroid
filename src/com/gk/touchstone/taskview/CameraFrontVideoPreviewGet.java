...
public class CameraFrontVideoPreviewGet extends Activity {
	/** 图片媒体类型 **/
	...
	private void startmediaRecorder() {
		...
		CamcorderProfile mCamcorderProfile = CamcorderProfile.get(
				CameraInfo.CAMERA_FACING_BACK, CamcorderProfile.QUALITY_HIGH);
	...
	class testThread extends Thread {
		...
		public void run() {
			...
			// System.out.println("FrontVideo"+getCameraTask().timeCount);
			...
			while (newTimeCount > 0) {
				try {
					...
					tm.getCameraTask(className).writeResult(newTimeCount,
							Constants.FAIL, e.getMessage());
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
